...
final class MySQLQueries {
	 ...
	 * DataObiettivo </p> </li> <li> <p> Urgenza </p> </li> </ul>
	 */

	static final String INSERT_NEW_OPERATION = "insert into operazione(IDSegnalazione,DataSegnalazione,DataObiettivo,Urgenza) values(?,?,?,?)";
